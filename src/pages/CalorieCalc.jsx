...
function CalorieCalc() {
    ...
    const [formData, setFormData] = useState({
        ...
        // Include other nutritional goals if needed
    });
            ...
            {modalOpen && (
                <dialog id="my_modal_2" className="modal" open>
                    <div className="modal-box">
                        <h3 className="font-bold text-lg">Calorie Calculation Results</h3>
                        <button className="btn btn-primary w-full mb-2" onClick={() => updateCaloriesAndClose(results.maintainWeight)}>Maintain Weight: {results.maintainWeight} Calories/day</button>
                        <button className="btn btn-primary w-full mb-2" onClick={() => updateCaloriesAndClose(results.mildWeightLoss)}>Mild Weight Loss: {results.mildWeightLoss} Calories/day</button>
                        <button className="btn btn-primary w-full mb-2" onClick={() => updateCaloriesAndClose(results.weightLoss)}>Weight Loss: {results.weightLoss} Calories/day</button>
                        <button className="btn btn-primary w-full mb-2" onClick={() => updateCaloriesAndClose(results.weightGain)}>Weight Gain: {results.weightGain} Calories/day</button>
                    </div>
